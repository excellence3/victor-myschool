...
public class BootstrapData implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception{
        ...
        Student student2 = new Student("Daffy","Duck",12,class1);
        Student student3 = new Student("Porky","Pig",11,class1);
        Student student4 = new Student("Speedy","Gonzales",10,class2);
        Student student5 = new Student("Wile E.","Coyote",11,class3);
        Student student6 = new Student("Lola","Bunny",12,class3);
